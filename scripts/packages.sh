...
required=(hyprland waybar kitty firefox-esr rofi sway-notification-center hyprpaper hyprlock hypridle grim slurp wl-clipboard cliphist thunar wireplumber zenity xdg-desktop-portal xdg-desktop-portal-hyprland qt5ct qt6ct papirus-icon-theme fonts-jetbrains-mono)
